...
def get_params():
    params = {
        'weight': '/amax/tyut/user/zwk/zlw/glass/3yolo/ultralytics-yolo11-main/runs/train/exp1_yolo8_PCAA_AFGC/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:3',
...
if __name__ == '__main__':
    ...
    model(r'/amax/tyut/user/zwk/zlw/glass/dataset_demo/images/train/3.jpg', 'result')
